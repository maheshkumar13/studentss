var ComponentsTypeahead = function() {
	var e = function() {
		...
		a.initialize(), App.isRTL()
				&& $("#typeahead_example_3").attr("dir", "rtl"), $(
				"#typeahead_example_3").typeahead(
				null,
				{
		...
		n.initialize(), i.initialize(), App.isRTL()
		...
		a.initialize(), App.isRTL()
				...
				"#typeahead_example_modal_3").typeahead(
				null,
				{
		...
		n.initialize(), i.initialize(), $("#typeahead_example_modal_4")
				.typeahead({
					hint : !App.isRTL(),
					highlight : !0
				}, {
